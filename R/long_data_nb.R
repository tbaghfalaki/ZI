...
#'
#' Simulated data were generated in which "Y1" follows a hurdle negative binomial distribution, "obstime" represents the observed time with two covariates x1 and x2.
#'
#'
#' @name long_data_nb
